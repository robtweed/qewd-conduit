...
export function apis(context) {
  ...
  let apis = {
    ...
    getProfile: async function() {
      let host = context.host || '';
      let fetch_url = host + '/api/profiles/' + context.author;
      let options = {
        method: 'GET',
        headers: {
          'Content-type': 'application/json',
    ...
    getArticleBySlug: async function() {
      let host = context.host || '';
      let fetch_url = context.host + '/api/articles/' + context.slug;
      let options = {
        method: 'GET',
        headers: {
          'Content-type': 'application/json',
    ...
    getComments: async function() {
      let host = context.host || '';
      let fetch_url = context.host + '/api/articles/' + context.slug + '/comments';
      let options = {
        method: 'GET',
        headers: {
          'Content-type': 'application/json',
    ...
    registerUser: async function(username, email, password) {
      ...
      let host = context.host || '';
      let fetch_url = context.host + '/api/users';
      let options = {
        method: 'POST',
        headers: {
          'Content-type': 'application/json'
    ...
    authenticateUser: async function(email, password) {
      ...
      let host = context.host || '';
      let fetch_url = context.host + '/api/users/login';
      let options = {
        method: 'POST',
        headers: {
          'Content-type': 'application/json'
    ...
    getUser: async function() {
      let host = context.host || '';
      let jwt = context.jwt;
      let fetch_url = context.host + '/api/user';
      let options = {
        method: 'GET',
        headers: {
          'Content-type': 'application/json',
    ...
    follow: async function(author) {
      let host = context.host || '';
      let jwt = context.jwt;
      let fetch_url = context.host + '/api/profiles/' + author + '/follow';
      let options = {
        method: 'POST',
        headers: {
          'Content-type': 'application/json',
    ...
    favourite: async function(slug) {
      let host = context.host || '';
      let jwt = context.jwt;
      let fetch_url = context.host + '/api/articles/' + slug + '/favorite';
      let options = {
        method: 'POST',
        headers: {
          'Content-type': 'application/json',
    ...
    addComment: async function(slug, text) {
      ...
      let host = context.host || '';
      let fetch_url = context.host + '/api/articles/' + slug + '/comments';
      let options = {
        method: 'POST',
        headers: {
          'Content-type': 'application/json',
    ...
    deleteComment: async function(id) {
      ...
      let host = context.host || '';
      let fetch_url = context.host + '/api/articles/' + context.slug + '/comments/' + id;
      let options = {
        method: 'DELETE',
        headers: {
          'Content-type': 'application/json',
    ...
    createArticle: async function(title, description, body, tagList) {
      ...
      let host = context.host || '';
      let fetch_url = context.host + '/api/articles';
      let options = {
        method: 'POST',
        headers: {
          'Content-type': 'application/json',
    ...
    deleteArticle: async function(slug) {
      ...
      let host = context.host || '';
      let fetch_url = context.host + '/api/articles/' + slug;
      let options = {
        method: 'delete',
        headers: {
          'Content-type': 'application/json',
