...
function changeEmail(id, newEmail) {
  ...
  var usersDoc = this.db.use('conduitUsers');
...
function authenticate(email, password) {
  if (emailExists.call(this, email)) {
    ...
    var hash = this.db.use('conduitUsers', 'byId', id, 'password').value;
...
function get(id) {
  ...
  var userDoc = this.db.use('conduitUsers', 'byId', id);
...
function favorite(userId, articleId) {
  ...
  var favoritedDoc = this.db.use('conduitUsers', 'byId', userId, 'favorited', articleId);
  //var favoriteCountDoc = new this.documentStore.DocumentNode('conduitArticles', ['byId', articleId, 'favoritesCount']);
  var favoriteCountDoc = this.db.use('conduitArticles', 'byId', articleId, 'favoritesCount');
...
function getProfile(ofUserId, byUserId) {
  ...
  var usersDoc = this.db.use('conduitUsers', 'byId');
