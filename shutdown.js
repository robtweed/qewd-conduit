/*
 ...
 ----------------------------------------------------------------------------
 | QEWD-Conduit: Clean Container Shutdown                                   |
 |                                                                          |
...
module.exports = function() {
  ...
  if (!fs.existsSync(config_path)) {
    ...
    console.log('*** Unable to continue shutting down the QEWD-Conduit Container');
    return;
  }
  try {
  ...
  var options = {
    url: 'http://conduit:' + config.qewd.port + '/conduit/shutdown',
    method: 'POST',
    headers: {
      Authorization: auth,
  ...
  console.log(result);
  console.log('QEWD-Conduit Container has been signalled to stop');
