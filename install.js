...
module.exports = function() {
  ...
  var start_container = [
    ...
    "docker run -d --name conduit --rm --network qewd-conduit -p {{port}}:{{internal_port}} -v {{volume_path}}:/opt/qewd/mapped {{ydb_persistence}} {{container}}",
    "echo 'conduit Container has been started'"
  ];

  var stop_container = [
    "#!/bin/bash",
    "# This script will cleanly stop the conduit Container by issuing a command to QEWD to stop",
    "#",
    "#",
    "#  Run this script from the QEWD-Conduit folder using:",
    "#",
    "#     ./stop",
    "#",
    "echo 'Stopping conduit Container'",
    "#",
    "#  Send authenticated requests to cleanly shut down QEWD Containers",
    "#",
    "docker run -it --name conduit_shutdown --rm --network qewd-conduit -v $PWD:/node -e \"node_script=shutdown\" rtweed/node-runner"
  ];
  ...
  console.log(' ');
  console.log('*************** QEWD-Conduit Installer ***************');
  //console.log(' ');
  ...
  console.log('  needed by QEWD-Conduit, and correctly configure it for');
  ...
  do {
    console.log(' ');
    console.log('Specify the port on which the QEWD-Conduit Web Server will listen.');
    console.log(' ');
    port = ask.question('QEWD-Conduit port (' + port + '): ', {defaultInput: port});
  ...
  console.log(' ');
  console.log('QEWD-Conduit Port will be ' + port);
  ...
  if (fs.existsSync(install_modules_path)) {
    ...
    console.log('that are required by your QEWD-Conduit system.');
  ...
  // QEWD-Conduit Folder for volume mapping

  console.log(' ');
  console.log('The QEWD-Conduit Container must map the qewd-conduit folder,');
  ...
  do {
    console.log(' ');
    volume_path = ask.question('QEWD-Conduit folder (' + volume_path + '): ', {defaultInput: volume_path});
    if (volume_path !== '') {
      ok = true;
    }
    else {
  ...
  console.log(' ');
  console.log('You can now start up the QEWD-Conduit Container by running the commands:');
