...
module.exports = function(args, finished) {
  ...
  let errors = validation.bodyAndFields(args, 'comment', ['body']);
  ...
  let commentId = db.comments.create.call(this, id, articleId, args.req.body.comment.body);

  // fetch and return the comment document, with author profile

  let comment = db.comments.get.call(this, commentId, id);
